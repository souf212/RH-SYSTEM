...
namespace PFA_TEMPLATE.Migrations
{
    ...
    [Migration("20250405123625_first")]
    partial class first
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PFA_TEMPLATE.Models.EchangeTaches", b =>
                {
                    b.Property<int>("IdEchange")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IdEchange"));
                    ...
                    b.Property<int>("IdEmployeDemandeur")
                        .HasColumnType("int");

                    b.Property<int>("IdEmployeDestinataire")
                        .HasColumnType("int");

                    b.Property<int>("IdTacheDemandeur")
                        .HasColumnType("int");

                    b.Property<int>("IdTacheDestinataire")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdEmployeDemandeur");

                    b.HasIndex("IdEmployeDestinataire");

                    b.HasIndex("IdTacheDemandeur");

                    b.HasIndex("IdTacheDestinataire");

                    b.ToTable("EchangeTaches");
                });
            ...
            modelBuilder.Entity("PFA_TEMPLATE.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PFA_TEMPLATE.Models.EchangeTaches", b =>
                {
                    b.HasOne("PFA_TEMPLATE.Models.Employes", "EmployeDemandeur")
                        .WithMany()
                        .HasForeignKey("IdEmployeDemandeur")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PFA_TEMPLATE.Models.Employes", "EmployeDestinataire")
                        .WithMany()
                        .HasForeignKey("IdEmployeDestinataire")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PFA_TEMPLATE.Models.Taches", "TacheDemandeur")
                        .WithMany()
                        .HasForeignKey("IdTacheDemandeur")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PFA_TEMPLATE.Models.Taches", "TacheDestinataire")
                        .WithMany()
                        .HasForeignKey("IdTacheDestinataire")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("EmployeDemandeur");

                    b.Navigation("EmployeDestinataire");

                    b.Navigation("TacheDemandeur");

                    b.Navigation("TacheDestinataire");
                });
            ...
            modelBuilder.Entity("PFA_TEMPLATE.Models.Message", b =>
                {
                    ...
                    b.HasOne("PFA_TEMPLATE.Models.Employes", "Sender")
                        .WithMany()
