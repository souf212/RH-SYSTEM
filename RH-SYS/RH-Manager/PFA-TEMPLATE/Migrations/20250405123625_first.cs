        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeContrat = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EtatContrat = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminComment = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    JustificatifPath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_Employes_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "Employes",
                        principalColumn: "IdEmploye",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Messages_Employes_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Employes",
                        principalColumn: "IdEmploye",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdEchange = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    IdTacheDemandeur = table.Column<int>(type: "int", nullable: false),
                    IdTacheDestinataire = table.Column<int>(type: "int", nullable: false),
                    IdEmployeDemandeur = table.Column<int>(type: "int", nullable: false),
                    IdEmployeDestinataire = table.Column<int>(type: "int", nullable: false),
                    Statut = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    RaisonRefus = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EchangeTaches", x => x.IdEchange);
                    table.ForeignKey(
                        name: "FK_EchangeTaches_Employes_IdEmployeDemandeur",
                        column: x => x.IdEmployeDemandeur,
                        principalTable: "Employes",
                        principalColumn: "IdEmploye",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EchangeTaches_Employes_IdEmployeDestinataire",
                        column: x => x.IdEmployeDestinataire,
                        principalTable: "Employes",
                        principalColumn: "IdEmploye",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EchangeTaches_Taches_IdTacheDemandeur",
                        column: x => x.IdTacheDemandeur,
                        principalTable: "Taches",
                        principalColumn: "IdTaches",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EchangeTaches_Taches_IdTacheDestinataire",
                        column: x => x.IdTacheDestinataire,
                        principalTable: "Taches",
                        principalColumn: "IdTaches",
                        onDelete: ReferentialAction.Restrict);
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EchangeTaches_IdEmployeDemandeur",
                table: "EchangeTaches",
                column: "IdEmployeDemandeur");

            migrationBuilder.CreateIndex(
                name: "IX_EchangeTaches_IdEmployeDestinataire",
                table: "EchangeTaches",
                column: "IdEmployeDestinataire");

            migrationBuilder.CreateIndex(
                name: "IX_EchangeTaches_IdTacheDemandeur",
                table: "EchangeTaches",
                column: "IdTacheDemandeur");

            migrationBuilder.CreateIndex(
                name: "IX_EchangeTaches_IdTacheDestinataire",
                table: "EchangeTaches",
                column: "IdTacheDestinataire");
