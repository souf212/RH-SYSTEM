...
namespace PFA_TEMPLATE.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<EchangeTaches> EchangeTaches { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
         ...
         .OnDelete(DeleteBehavior.Restrict); // Prevent cascade delete
            ...
            modelBuilder.Entity<Message>()
                ...
                .OnDelete(DeleteBehavior.Restrict); // Prevent cascade delete
            modelBuilder.Entity<EchangeTaches>()
            .HasOne(e => e.TacheDemandeur)
            .WithMany()
            .HasForeignKey(e => e.IdTacheDemandeur)
            .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<EchangeTaches>()
                .HasOne(e => e.TacheDestinataire)
                .WithMany()
                .HasForeignKey(e => e.IdTacheDestinataire)
                .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<EchangeTaches>()
                .HasOne(e => e.EmployeDemandeur)
                .WithMany()
                .HasForeignKey(e => e.IdEmployeDemandeur)
                .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<EchangeTaches>()
                .HasOne(e => e.EmployeDestinataire)
                .WithMany()
                .HasForeignKey(e => e.IdEmployeDestinataire)
                .OnDelete(DeleteBehavior.Restrict);
