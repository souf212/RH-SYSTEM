...
namespace PFA_TEMPLATE.Models
{
    ...
    public class Employes
    {
        ...
        // New properties for manager relationship
        public int? ManagerId { get; set; }
        public Manager? Manager { get; set; }

        // Additional properties for specific roles
        public string? SpecificRole { get; set; } // DevOps, Developer, SysAdmin, IT Support
