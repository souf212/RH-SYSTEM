...
namespace PFA_TEMPLATE.Migrations
{
    ...
    [Migration("20250322213133_AddResponsableToEmployes")]
    partial class AddResponsableToEmployes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PFA_TEMPLATE.Models.Employes", b =>
                {
                    ...
                    b.Property<int?>("ResponsableUtilisateurId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResponsableUtilisateurId");
            ...
            modelBuilder.Entity("PFA_TEMPLATE.Models.Employes", b =>
                {
                    ...
                    b.HasOne("PFA_TEMPLATE.viewModels.Utilisateur", "ResponsableUtilisateur")
                        .WithMany()
                        .HasForeignKey("ResponsableUtilisateurId");

                    b.Navigation("ResponsableUtilisateur");
