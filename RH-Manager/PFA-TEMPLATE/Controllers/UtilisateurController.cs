    ...
    public class UtilisateurController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            if (!User.IsInRole("Admin") || id == null)
            {
                ...
                // Get contrat info for the current user
                await SetContratViewBag(currentUser.Id);
            ...
            // Get contrat info for the requested user
            await SetContratViewBag(user.Id);
            return View(user);
        }

        private async Task SetContratViewBag(int userId)
        {
            ...
            ViewBag.HasContrat = contrat != null;
